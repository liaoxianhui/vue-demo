    ...
    <div class="box2">
      <el-card>
        ...
        <div class=" df jc_b">
          ...
          <div>
            <button style="margin-right:10px;margin:0 10px" @click="all">All</button>
            <button style="margin-right:10px;margin:0 10px" @click="active">Active</button>
            <button style="margin:0 10px" @click="completed">Completed</button>
          </div>
        </div>
      </el-card>
    </div>
