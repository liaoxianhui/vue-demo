  ...
  <div class="box df">
    <div class="box1">
      <el-card>
        <el-table :data="orderData" style="width: 100%">
          <el-table-column prop="num" label="Order _No" width="300">
          </el-table-column>
    ...
    <div class="box2">
      <el-card>
        ...
        <div v-for="(item,index) in todolist" :key="index" class=" df jc_b" style="margin-bottom:10px">
          <div class=" df">
        ...
        <div class=" df jc_b">
          ...
          <div>
            <button style="margin-right:10px;padding:0 10px" @click="all">All</button>
            <button style="margin-right:10px;padding:0 10px" @click="active">Active</button>
            <button style="padding:0 10px" @click="completed">Completed</button>
          </div>
        </div>
      </el-card>
    </div>
...
export default {
  ...
  methods: {
    ...
    solo(){
      this.Select=this.todolist.every(item=>{
        return item.checked
      })
    },
    close(item,index){
