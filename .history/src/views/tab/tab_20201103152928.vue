<template>
  <div>
    ...
    >
    <el-link type="success" @click="Read" style="margin-right: 10px"
      >已读消息({{ list.length }})</el-link
    >
    <el-link type="warning" @click="recovery" style="margin-right: 10px"
      >回收站({{ nuxt.length }})</el-link
    >
    <div>
      <el-col>
        <el-card>
