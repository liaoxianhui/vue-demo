<template>
  <div>
    <el-link type="primary" @click="Unread" style="margin-right: 10px;"
      >未读消息({{ nuxt.length }})</el-link
    >
    <el-link type="success" @click="Read" style="margin-right: 10px;">已读消息({{list.length}})</el-link>
    <el-link type="warning" @click="recovery" style="margin-right: 10px;">回收站({{nuxt.length}})</el-link>
    <div>
      <el-col>
        <el-card >
          <div v-for="item in list" :key="item.id" > 
            <div style="height: 80px;border-bottom:1px solid gray;line-height:80px" class="df jc_b" >
