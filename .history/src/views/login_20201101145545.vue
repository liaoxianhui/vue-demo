          ...
          >
            ...
            <el-form-item>
              <el-button type="primary" style="width: 45%" @click="login"
                >立即登录</el-button
              >
              <el-button type="primary" style="width: 45%" @click="rsgister"
                >立即注册</el-button
              >
            </el-form-item>
          </el-form>
...
.bgc {
  width: 100vw;
  height: 100vh;
  background-image: url("https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2899993874,1088991247&fm=26&gp=0.jpg");
